...
# EXISTING IMAGE, VIDEO, AUDIO ROUTES (UNCHANGED)
...
def upload_training_image():
    try:
        ...
        return jsonify({
            'status': 'success',
            'message': f'Image uploaded to {category} category',
            'filename': filename
        })
...
def upload_training_video():
    try:
        ...
        category_path = os.path.join('datasets', category_folder)
        os.makedirs(category_path, exist_ok=True)
        ...
        return jsonify({
            'status': 'success',
            'message': f'Video uploaded to {category} category',
            'filename': filename,
            'category': category
        })
...
def upload_training_audio():
    try:
        ...
        return jsonify({
            'status': 'success',
            'message': f'Audio uploaded to {category} category',
            'filename': filename,
            'category': category
        })
